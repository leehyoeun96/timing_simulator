...
feature_set = {
    'task_A': task_feat(prd=70, off=0, aff=0),
    'task_B': task_feat(prd=23, off=0, aff=1),
    'task_C': task_feat(prd=70, off=0, aff=0),
    'task_D': task_feat(prd=23, off=0, aff=1),
    'task_E': task_feat(prd=23, off=0, aff=1),
