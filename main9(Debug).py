...
feature_set = {
    ...
    'task_B': task_feat(prd=33, off=0, aff=1),
    'task_C': task_feat(prd=25, off=0, aff=2),
    'task_D': task_feat(prd=100, off=0, aff=0),
    'task_E': task_feat(prd=33, off=0, aff=1),
    'task_F': task_feat(prd=25, off=0, aff=2),
    'task_G': task_feat(prd=10, off=0, aff=3),
    'task_H': task_feat(prd=10, off=0, aff=3),
}
ext_table = {
    'task_A': [0, 1],
    'task_B': [0, 0, 1],
