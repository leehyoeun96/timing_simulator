...
feature_set = {
    ...
    'task_B': task_feat(prd=200, off=0, aff=0),
    'task_C': task_feat(prd=200, off=0, aff=0),
    'task_D': task_feat(prd=100, off=0, aff=1),
    'task_E': task_feat(prd=70, off=0, aff=2),
    'task_F': task_feat(prd=100, off=0, aff=1),
